...
def load_data():
    ...
    # Fill empty cells to prevent 'float vs str' errors
...
try:
    ...
    if main_page == "Draft Room":
        ...
        # ==========================================
            ...
            fig_perf = px.scatter(owner_draft, x="Round", y="Success Score", color="Grade", size="PPG", hover_data=["Player Name", "Year"])
